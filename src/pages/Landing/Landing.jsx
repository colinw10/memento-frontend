/**
 * Landing Page
 * 🔴 PABLO - Animated particles landing for unauthenticated users
 */
    ...
    initParticlesEngine(async (engine) => {
      ...
      engine.addPathGenerator("sineWave", {
        generate: (particle) => {
          ...
          const section = Math.floor((particleSeed % 89) / 13);
          ...
          let sectionMultiplier = { x: 1, y: 1 };
          switch(section) {
            case 0: sectionMultiplier = { x: PHI, y: PHI_INV * 1.5 }; break;
            case 1: sectionMultiplier = { x: PHI_INV, y: PHI }; break;
            case 2: sectionMultiplier = { x: 1, y: 1 }; break;
            case 3: sectionMultiplier = { x: PHI_INV * 0.8, y: PHI * 0.7 }; break;
            case 4: sectionMultiplier = { x: PHI_INV * 0.5, y: PHI_INV * 0.5 }; break;
            case 5: sectionMultiplier = { x: PHI * 1.2, y: PHI * 1.1 }; break;
            default: sectionMultiplier = { x: PHI_SQ * 0.4, y: PHI_SQ * 0.3 };
          }
